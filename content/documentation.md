...
$$  BW_{PCIe,theoretical} = R_{GT}/s \times  N_{lanes} \times  (128/130) \div  8 \quad \text{(Equation 14)}  $$
...
$$  TFLOPS = N_{cores} \times  f_{clock} \times  2 FLOP/clock/core (tensor cores) \quad \text{(Equation 20)}  $$
